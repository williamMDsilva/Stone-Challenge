...
export class RouteHistoryClientIdUseCase implements Route {
    readonly path
    readonly method
    ...
    public static create(fetchHistoryUseCase: FetchHistoryUseCase) {
        return new RouteHistoryClientIdUseCase("/history/:clientId", Method.GET, ["ADMIN", "USER"], fetchHistoryUseCase)
    }
